...
ggplot(cleaned_data, aes(x = FFMC, y = ISI)) +
  ...
  scale_fill_viridis_c() +   
  theme_minimal() + 
  ggtitle("Title: Relationship between FFMC and ISI after Removing Outliers")
```
...
stargazer(log_model, type = "text", title = "Log-Linear Regression Model Results", digits = 2, single.row = TRUE)
