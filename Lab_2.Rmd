...
```
```{r, echo=FALSE }
ggplot(exploration_set, aes(x = FFMC, y = ISI)) +
  geom_hex() +
...
```
```{r, echo=FALSE }
ggplot(cleaned_exploration_set, aes(x = FFMC, y = ISI)) +
  geom_hex() +               
  scale_fill_viridis_c() +   
  theme_minimal() + 
